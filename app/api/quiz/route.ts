...
import { z } from "zod"
import { ManyRequestError, NotAuthorizedError, ServerError, UnprocessableEntityError } from "../_services/errors"
	...
	try {
		...
		object = {
			quiz: {
				...
				matchingOptions: [],
				rightAnswerMatching: [],
				question: '¿Cuáles de las siguientes afirmaciones sobre la gestión de memoria en TypeScript son correctas?',
				type: 'multiple select',
				numberOfCorrectAnswers: 2,
				options: [
					'TypeScript utiliza un recolector de basura para gestionar la memoria automáticamente.',
					'Los tipos de datos en TypeScript no afectan la gestión de memoria.',
					'TypeScript permite la gestión manual de memoria a través de punteros.',
					'La gestión de memoria en TypeScript es similar a la de JavaScript.'
				],
				rightAnswer: [
					'TypeScript utiliza un recolector de basura para gestionar la memoria automáticamente.',
					'La gestión de memoria en TypeScript es similar a la de JavaScript.'
				],
				explanation: 'TypeScript, al ser un superconjunto de JavaScript, hereda su modelo de gestión de memoria, que incluye un recolector de basura que libera memoria automáticamente. Aunque TypeScript permite definir tipos de datos, esto no afecta directamente la gestión de memoria, ya que sigue utilizando el mismo mecanismo que JavaScript.'
			}
		}
...
{
  question: '¿Cuál de las siguientes afirmaciones sobre las estructuras de control en PHP es correcta?',
  type: 'multiple choice',
  numberOfCorrectAnswers: 1,
  options: [
	'Las estructuras de control solo se pueden usar en funciones.',
	'PHP no permite estructuras de control anidadas.',
	'Las estructuras de control permiten ejecutar diferentes bloques de código según condiciones.',
	'Las estructuras de control son exclusivas de los lenguajes de programación orientados a objetos.'
  ],
  rightAnswer: [
	'Las estructuras de control permiten ejecutar diferentes bloques de código según condiciones.'
  ],
  explanation: 'Las estructuras de control en PHP, como if, else, switch, y bucles, permiten ejecutar diferentes bloques de código basados en condiciones específicas. Esto es fundamental para la lógica de programación y no está limitado a funciones ni a la programación orientada a objetos.'
}
}
...
/*
		...
		object = {
			...
			quiz: {
				question: '¿Cuáles de las siguientes afirmaciones sobre los sistemas de tipos en TypeScript son correctas?',
				type: 'multiple select',
				codeSnippet: null,
				codeSnippetExplanation: null,
				matchingOptions: [],
				...
				numberOfCorrectAnswers: 2,
				options: [
					'TypeScript permite la inferencia de tipos.',
					'Los tipos en TypeScript son solo para la verificación en tiempo de ejecución.',
					'TypeScript no permite la creación de tipos personalizados.',
					'Los tipos en TypeScript pueden ser utilizados para definir interfaces.'
				],
				rightAnswer: [
					'TypeScript permite la inferencia de tipos.',
					'Los tipos en TypeScript pueden ser utilizados para definir interfaces.'
				],
				explanation: 'TypeScript es un superconjunto de JavaScript que añade tipos estáticos. Esto permite a los desarrolladores definir tipos personalizados y aprovechar la inferencia de tipos, lo que mejora la calidad del código y la detección de errores en tiempo de desarrollo. Sin embargo, los tipos en TypeScript son solo para la verificación en tiempo de compilación y no afectan el comportamiento en tiempo de ejecución.'
			}
...
/*	let object: IResponseQuiz = { quiz: null }
	...
	object = {
		...
		quiz: {
			...
			question: 'Empareja los tipos de datos de Ruby con sus descripciones correctas.',
			type: 'matching',
			numberOfCorrectAnswers: 1,
			codeSnippet: null,
			codeSnippetExplanation: null,
			...
			matchingOptions: ['Integer', 'String', 'Array', 'Hash'],
			rightAnswer: ['Integer', 'String', 'Array', 'Hash'],
			rightAnswerMatching: [
				'Un número entero',
				'Una secuencia de caracteres',
				'Un conjunto ordenado de elementos',
			...
			explanation: 'En Ruby, los tipos de datos básicos incluyen Integer, que representa números enteros; String, que representa secuencias de caracteres; Array, que es una colección ordenada de elementos; y Hash, que es una colección de pares clave-valor.'
		}
